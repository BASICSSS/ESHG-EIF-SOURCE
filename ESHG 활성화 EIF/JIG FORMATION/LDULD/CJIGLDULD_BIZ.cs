...
{
    public partial class CJIGLDULD_BIZ : CImplement, IEIF_Biz
    {
        #region Class Member variable
        public static string EQPTYPE = "JIGLDULD"; //$ 2021.07.05 : Modeler Element의 Nick과 반드시 일치 시키시오!!
        ...
        private CJIGLDULD BASE { get { return (Owner as CJIGLDULD); } }
        ...
        private Dictionary<string, string> PropertyDesc = new Dictionary<string, string>(); //Desc에서 값을 한번이라도 읽어오면, 내부 Dictionary에서 찾게 하자..
        ...
        protected override void DefineInternalVariable()
        {
            ...
            __INTERNAL_VARIABLE_STRING("V_W_LD_INPUT_STATION_EQP_ID", "EQP_INFO", enumAccessType.Virtual, false, true, string.Empty, string.Empty, "EQP ID");
            __INTERNAL_VARIABLE_STRING("V_W_EMPTY_OUTPUT_STATION_EQP_ID", "EQP_INFO", enumAccessType.Virtual, false, true, string.Empty, string.Empty, "EQP ID");
            __INTERNAL_VARIABLE_STRING("V_W_EMPTY_INPUT_STATION_EQP_ID", "EQP_INFO", enumAccessType.Virtual, false, true, string.Empty, string.Empty, "EQP ID");
            __INTERNAL_VARIABLE_STRING("V_W_ULD_OUTPUT_STATION_EQP_ID", "EQP_INFO", enumAccessType.Virtual, false, true, string.Empty, string.Empty, "EQP ID");
        ...
        protected override void DefineHandlers()
        {
            ...
            #region Event Registration : EQP(LD) -> Host Bit Area

            __EVENT_BOOLEANCHANGED(this.BASE.__G2_1_CARR_ID_RPT_01__I_B_TRAY_EXIST, __G2_1_CARR_ID_RPT_01__I_B_TRAY_EXIST_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_1_CARR_ID_RPT_01__I_B_TRIGGER_REPORT, __G2_1_CARR_ID_RPT_01__I_B_TRIGGER_REPORT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_2_CARR_JOB_START_RPT_01__I_B_TRIGGER_REPORT, __G2_2_CARR_JOB_START_RPT_01__I_B_TRIGGER_REPORT_OnBooleanChanged);

            __EVENT_BOOLEANCHANGED(this.BASE.__G4_6_CELL_INFO_REQ_01__I_B_BUFFER_EMPTY_YN, __G4_6_CELL_INFO_REQ_01__I_B_BUFFER_EMPTY_YN_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G4_6_CELL_INFO_REQ_01__I_B_TRIGGER_REPORT, __G4_6_CELL_INFO_REQ_01__I_B_TRIGGER_REPORT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_3_CARR_OUT_RPT_04__I_B_TRIGGER_REPORT, __G2_3_CARR_OUT_RPT_04__I_B_TRIGGER_REPORT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_3_CARR_OUT_RPT_01__I_B_TRIGGER_REPORT, __G2_3_CARR_OUT_RPT_01__I_B_TRIGGER_REPORT_OnBooleanChanged);
            #endregion

            #region Event Registration : EQP(LD) -> HOST Word Area

            #endregion

            #region Event Registration : EQP(ULD) -> Host Bit Area     
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_2_CARR_JOB_START_RPT_03__I_B_TRAY_EXIST, __G2_2_CARR_JOB_START_RPT_03__I_B_TRAY_EXIST_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_2_CARR_JOB_START_RPT_03__I_B_TRIGGER_REPORT, __G2_2_CARR_JOB_START_RPT_03__I_B_TRIGGER_REPORT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_2_CARR_JOB_START_RPT_02__I_B_TRIGGER_REPORT, __G2_2_CARR_JOB_START_RPT_02__I_B_TRIGGER_REPORT_OnBooleanChanged);
            ...
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_3_CARR_OUT_RPT_02__I_B_TRIGGER_REPORT, __G2_3_CARR_OUT_RPT_02__I_B_TRIGGER_REPORT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_3_CARR_OUT_RPT_03__I_B_TRIGGER_REPORT, __G2_3_CARR_OUT_RPT_03__I_B_TRIGGER_REPORT_OnBooleanChanged);
            #endregion

            #region Event Registration : EQP(ULD) -> Host Word Area

            #endregion


            #region Host Bit Event
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_1_CARR_ID_RPT_01__O_B_TRIGGER_REPORT_CONF, HOST_CONFIRM_BIT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_2_CARR_JOB_START_RPT_01__O_B_TRIGGER_REPORT_CONF, HOST_CONFIRM_BIT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G4_6_CELL_INFO_REQ_01__O_B_TRIGGER_REPORT_CONF, HOST_CONFIRM_BIT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_3_CARR_OUT_RPT_04__O_B_TRIGGER_REPORT_CONF, HOST_CONFIRM_BIT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_3_CARR_OUT_RPT_01__O_B_TRIGGER_REPORT_CONF, HOST_CONFIRM_BIT_OnBooleanChanged);

            __EVENT_BOOLEANCHANGED(this.BASE.__G2_2_CARR_JOB_START_RPT_03__O_B_TRIGGER_REPORT_CONF, HOST_CONFIRM_BIT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_2_CARR_JOB_START_RPT_02__O_B_TRIGGER_REPORT_CONF, HOST_CONFIRM_BIT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G4_6_CELL_INFO_REQ_03__O_B_TRIGGER_REPORT_CONF, HOST_CONFIRM_BIT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_3_CARR_OUT_RPT_02__O_B_TRIGGER_REPORT_CONF, HOST_CONFIRM_BIT_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_3_CARR_OUT_RPT_03__O_B_TRIGGER_REPORT_CONF, HOST_CONFIRM_BIT_OnBooleanChanged);
            ...
            # region InOut Port 
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_1_CARR_ID_RPT_02__I_B_TRAY_EXIST, __G2_1_CARR_ID_RPT_02__I_B_TRAY_EXIST_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_1_CARR_ID_RPT_02__I_B_TRIGGER_REPORT, __G2_1_CARR_ID_RPT_02__I_B_TRIGGER_REPORT_OnBooleanChanged);

            __EVENT_BOOLEANCHANGED(this.BASE.__G2_1_CARR_ID_RPT_03__I_B_TRAY_EXIST, __G2_1_CARR_ID_RPT_03__I_B_TRAY_EXIST_OnBooleanChanged);
            __EVENT_BOOLEANCHANGED(this.BASE.__G2_1_CARR_ID_RPT_03__I_B_TRIGGER_REPORT, __G2_1_CARR_ID_RPT_03__I_B_TRIGGER_REPORT_OnBooleanChanged);


            __EVENT_SHORTCHANGED(this.BASE.__T1_1_PORT_STAT_CHG_01__I_W_INPUT_ST_AVAIL, __T1_1_PORT_STAT_CHG_01__I_W_INPUT_ST_AVAIL_OnShortChanged);
            __EVENT_SHORTCHANGED(this.BASE.__T1_1_PORT_STAT_CHG_02__I_W_OUTPUT_ST_AVAIL, __T1_1_PORT_STAT_CHG_02__I_W_OUTPUT_ST_AVAIL_OnShortChanged);

            __EVENT_SHORTCHANGED(this.BASE.__T1_1_PORT_STAT_CHG_03__I_W_INPUT_ST_AVAIL, __T1_1_PORT_STAT_CHG_03__I_W_INPUT_ST_AVAIL_OnShortChanged);
            __EVENT_SHORTCHANGED(this.BASE.__T1_1_PORT_STAT_CHG_04__I_W_OUTPUT_ST_AVAIL, __T1_1_PORT_STAT_CHG_04__I_W_OUTPUT_ST_AVAIL_OnShortChanged);
            #endregion
            ...
            __EVENT_BOOLEANCHANGED(this.BASE.__S7_5_TRAY_TRNSINFO_01__O_B_BCR_RETRY, __S7_5_TRAY_TRNSINFO_01__O_B_BCR_RETRY_OnBooleanChanged);
            ...
            __EVENT_BOOLEANCHANGED(this.BASE.__S7_5_TRAY_TRNSINFO_02__I_B_STACKED_TRAY_EXIST, __S7_5_TRAY_TRNSINFO_02__I_B_STACKED_TRAY_EXIST_OnBooleanChanged);
            ...
            __EVENT_BOOLEANCHANGED(this.BASE.__S7_5_TRAY_TRNSINFO_02__O_B_BCR_RETRY, __S7_5_TRAY_TRNSINFO_02__O_B_BCR_RETRY_OnBooleanChanged);
            #endregion
        ...
        private void __SMOKE_RPT__I_B_SMOKE_DETECT_REQ_OnBooleanChanged(CVariable sender, bool value)
        {
            try
            {
                ...
                inData.INDATA[0].TRAY_EXIST = this.BASE.G2_1_CARR_ID_RPT_01__I_B_TRAY_EXIST ? "1" : "0";
        ...
        private void TacttimeReport()
        {
            try
            {
                ...
                return; // JIGLDULD의 경우 Tact Time 보고 안함(추후 사용가능성이 있어 사전 반영 함)

                #region Tact Time 보고 필요시 주석 해제
        ...
        {
            if (this.BASE.G2_1_CARR_ID_RPT_01__O_B_TRIGGER_REPORT_CONF)
            {
                this.BASE.G2_1_CARR_ID_RPT_01__O_W_TRIGGER_REPORT_ACK = (ushort)eConfirm.DEFAULT;
                this.BASE.G2_1_CARR_ID_RPT_01__O_B_TRIGGER_REPORT_CONF = false;
            }

            if (this.BASE.G2_2_CARR_JOB_START_RPT_01__O_B_TRIGGER_REPORT_CONF) //$ 2021.10.20 : 누락된 Bit에 대한 초기화 추가
            {
                this.BASE.G2_2_CARR_JOB_START_RPT_01__O_W_TRIGGER_REPORT_ACK = (ushort)eConfirm.DEFAULT;
                this.BASE.G2_2_CARR_JOB_START_RPT_01__O_B_TRIGGER_REPORT_CONF = false;
            }

            if (this.BASE.G2_3_CARR_OUT_RPT_01__O_B_TRIGGER_REPORT_CONF)
            {
                this.BASE.G2_3_CARR_OUT_RPT_01__O_W_TRIGGER_REPORT_ACK = (ushort)eConfirm.DEFAULT;
                this.BASE.G2_3_CARR_OUT_RPT_01__O_B_TRIGGER_REPORT_CONF = false;
            }
        ...
        //$ 2021.07.20 : Jig 전 Cell 양품인 경우 Selector를 Skip하게 하여 가동률을 증가시킴
        private void ReportJigSelectorSkip(string trayID)
        {
            Int32 iRst = 0;
            String strBizName = "BR_SET_JIG_FORM_ULD_SELECTOR_AUTO_START_END";
            Exception bizEx = null;

            try
            {
                CBR_SET_JIG_FORM_ULD_SELECTOR_AUTO_START_END_IN inData = CBR_SET_JIG_FORM_ULD_SELECTOR_AUTO_START_END_IN.GetNew(this);
                CBR_SET_JIG_FORM_ULD_SELECTOR_AUTO_START_END_OUT outData = CBR_SET_JIG_FORM_ULD_SELECTOR_AUTO_START_END_OUT.GetNew(this);
                inData.INDATA_LENGTH = 1;
